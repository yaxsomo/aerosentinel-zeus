...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(SPI5_NSS_CONFMEM_GPIO_Port, SPI5_NSS_CONFMEM_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : SPI5_NSS_CONFMEM_Pin */
  GPIO_InitStruct.Pin = SPI5_NSS_CONFMEM_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(SPI5_NSS_CONFMEM_GPIO_Port, &GPIO_InitStruct);
