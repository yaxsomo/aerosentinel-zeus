...
void HAL_USART_MspInit(USART_HandleTypeDef* husart)
{
  ...
  */
    ...
    PG13     ------> USART6_NSS
    */
    GPIO_InitStruct.Pin = ECHO_CK_Pin|ECHO_NSS_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    ...
    GPIO_InitStruct.Pin = ECHO_TX_Pin|ECHO_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF7_USART6;
...
void HAL_USART_MspDeInit(USART_HandleTypeDef* husart)
{
  if(husart->Instance==USART6)
  {
    ...
    PG13     ------> USART6_NSS
    */
    HAL_GPIO_DeInit(GPIOG, ECHO_CK_Pin|ECHO_NSS_Pin);

    HAL_GPIO_DeInit(GPIOC, ECHO_TX_Pin|ECHO_RX_Pin);
